...
pyang --ietf --max-line-length=70 -p ../ ../ietf-keychain\@*.yang
...
./validate.sh ietf-keychain\@*.yang ex-keychain.xml
#./validate.sh ietf-keychain\@*.yang ex-keychain-rpc-gpk-restconf-json.xml
#./validate.sh ietf-keychain\@*.yang ex-keychain-rpc-gcsr-netconf.xml
